---
name: QuantumOperatorAlgebra.jl bug report
about: Create a bug report to help us improve QuantumOperatorAlgebra.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("QuantumOperatorAlgebra")`:
```julia
julia> using Pkg; Pkg.status("QuantumOperatorAlgebra")
[YOUR OUTPUT HERE]
```
